...
lr_params_C_AA, lr_params_C_AI, lr_params_C_AW, lr_params_C_CC, lr_params_C_QA = [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2)
...
rf_params_est_AA, rf_params_est_AI, rf_params_est_AW, rf_params_est_CC, rf_params_est_QA = [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2)
rf_params_md_AA, rf_params_md_AI, rf_params_md_AW, rf_params_md_CC, rf_params_md_QA = [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2)
rf_params_mss_AA, rf_params_mss_AI, rf_params_mss_AW, rf_params_mss_CC, rf_params_mss_QA = [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2), [None] * (nsplits+2)
